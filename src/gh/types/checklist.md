...
</div></div></div><div><div class="flex gap-2"><div class="font-mono p" id="p_titleEntities" data-anchor="true"><span class="font-bold">titleEntities</span><span class="opacity-50"><span title="Optional" class="cursor-help">?</span>:</span> <a href="/gh/types/messageentity">MessageEntity</a><span class="opacity-50">[]</span></div></div><div class="pl-3"><div class="no-margin">

The entities of the checklist's title.

</div></div></div><div><div class="flex gap-2"><div class="font-mono p" id="p_items" data-anchor="true"><span class="font-bold">items</span><span class="opacity-50">:</span> <a href="/gh/types/checklistitem">ChecklistItem</a><span class="opacity-50">[]</span></div></div><div class="pl-3"><div class="no-margin">
