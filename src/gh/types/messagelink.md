...
</div></div></div><div><div class="flex gap-2"><div class="font-mono p" id="p_linkPreview" data-anchor="true"><span class="font-bold">linkPreview</span><span class="opacity-50">:</span> <a href="/gh/types/linkpreview">LinkPreview</a> <span class="opacity-50">&amp;</span> <span class="font-mono">{ <span class="font-bold">url</span><span class="opacity-50">:</span> <span href="/">NonNullable</span><span class="opacity-50">&lt;</span><a href="/gh/types/linkpreview">LinkPreview</a>[<span>&quot;url&quot;</span>]<span class="opacity-50">></span> }</span></div><div class="flex items-center"><div class="bg-dbt px-1.5 rounded-md select-none text-fgt text-[10px]">DISCRIMINATOR</div></div></div></div></div>
