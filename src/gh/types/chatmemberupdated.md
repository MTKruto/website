...
</div></div></div><div><div class="flex gap-2"><div class="font-mono"><span class="font-bold">oldChatMember</span><span class="opacity-50">:</span> <a href="/gh/types/chatmember"  >ChatMember</a></div></div><div class="pl-3"><div class="no-margin">

The old status of the chat member.

</div></div></div><div><div class="flex gap-2"><div class="font-mono"><span class="font-bold">newChatMember</span><span class="opacity-50">:</span> <a href="/gh/types/chatmember"  >ChatMember</a></div></div><div class="pl-3"><div class="no-margin">
