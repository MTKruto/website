...
parent: /methods
metas:
  description: Cast a vote. User-only. 
---
...
</div></div></div><div><div class="font-mono" id="p_optionIndexes" data-anchor="true"><span class="font-bold">optionIndexes</span><span class="opacity-50">:</span> <span>number</span><span class="opacity-50">[]</span></div><div class="pl-3"><div class="no-margin">
