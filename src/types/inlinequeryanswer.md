...
</div></div></div><div><div class="flex gap-2"><div class="font-mono p" id="p_results" data-anchor="true"><span class="font-bold">results</span><span class="opacity-50">:</span> <a href="/types/inlinequeryresult">InlineQueryResult</a><span class="opacity-50">[]</span></div></div><div class="pl-3"><div class="no-margin">
