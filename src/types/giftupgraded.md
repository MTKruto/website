...
</div></div></div><div><div class="flex gap-2"><div class="font-mono p" id="p_value" data-anchor><span class="font-bold">value</span><span class="opacity-50"><span title="Optional" class="cursor-help">?</span>:</span> <a href="/types/giftvalue"  >GiftValue</a></div></div><div class="pl-3"><div class="no-margin">
