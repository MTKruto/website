...
</div></div></div><div><div class="flex gap-2"><div class="font-mono p" id="p_giveaway" data-anchor><span class="font-bold">giveaway</span><span class="opacity-50">:</span> <a href="/types/giveaway"  >Giveaway</a></div><div class="flex items-center"><div class="bg-dbt px-1.5 rounded-md select-none text-fgt text-[10px]">DISCRIMINATOR</div></div></div></div></div>
