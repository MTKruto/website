...
</div></div></div><div><div class="flex gap-2"><div class="font-mono p" id="p_button" data-anchor="true"><span class="font-bold">button</span><span class="opacity-50">:</span> <a href="/types/richtextbutton">RichTextButton</a></div></div><div class="pl-3"><div class="no-margin">
