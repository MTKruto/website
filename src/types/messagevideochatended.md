...
</div></div></div><div><div class="flex gap-2"><div class="font-mono p" id="p_videoChatEnded" data-anchor><span class="font-bold">videoChatEnded</span><span class="opacity-50">:</span> <span class="font-mono">{ <span class="font-bold">duration</span><span class="opacity-50">:</span> <span>number</span> }</span></div><div class="flex items-center"><div class="bg-dbt px-1.5 rounded-md select-none text-fgt text-[10px]">DISCRIMINATOR</div></div></div></div></div>
