...
parent: /methods
metas:
  description: Add an option to a poll. User-only.
---

Add an option to a poll.<span class="select-none"> <span class="inline-flex w-fit items-center" style="font-size:12px;white-space:nowrap;word-break:keep-all;"><span class="w-fit bg-dbt select-none text-fgt" style="padding:2px 8px;border-radius:12px;">USER-ONLY</span></span> </span>
...
</div></div></div><div><div class="font-mono" id="p_option" data-anchor="true"><span class="font-bold">option</span><span class="opacity-50">:</span> <a href="/types/inputpolloption">InputPollOption</a></div><div class="pl-3"><div class="no-margin">
