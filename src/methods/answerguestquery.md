...
</div></div></div><div><div class="font-mono" id="p_result" data-anchor="true"><span class="font-bold">result</span><span class="opacity-50">:</span> <a href="/types/inlinequeryresult">InlineQueryResult</a></div></div></div>
