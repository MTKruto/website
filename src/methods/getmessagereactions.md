...
parent: /methods
metas:
  description: Get a list of reactions made to a message. User-only.
---
...
</div></div></div><div class="flex flex-col gap-3"><div><div class="flex gap-2"><div class="font-mono p" id="p_reaction" data-anchor="true"><span class="font-bold">reaction</span><span class="opacity-50"><span title="Optional" class="cursor-help">?</span>:</span> <a href="/types/reaction">Reaction</a></div></div><div class="pl-3"><div class="no-margin">
...
<div class="font-mono"><a href="/types/messagereactionlist">MessageReactionList</a></div>
