...
parent: /methods
metas:
  description: Send a callback query. User-only.
---
...
</div></div></div><div><div class="font-mono" id="p_question" data-anchor="true"><span class="font-bold">question</span><span class="opacity-50">:</span> <a href="/types/callbackqueryquestion">CallbackQueryQuestion</a></div><div class="pl-3"><div class="no-margin">
