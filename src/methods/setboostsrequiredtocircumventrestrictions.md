...
parent: /methods
metas:
  description: Set the number of boosts required to circumvent a chat's default restrictions. User-only.
---

Set the number of boosts required to circumvent a chat's default restrictions.<span class="select-none"> <span class="inline-flex w-fit items-center" style="font-size:12px;white-space:nowrap;word-break:keep-all;"><span class="w-fit bg-dbt select-none text-fgt" style="padding:2px 8px;border-radius:12px;">USER-ONLY</span></span> </span>
